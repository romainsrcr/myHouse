...
class Application: NSObject{
    ...
    static var name:String = { return UserDefaults.standard.string(forKey: "appName") ?? "" }()
    static var accessKey:String = { return UserDefaults.standard.string(forKey: "accessKey") ?? "" }()
